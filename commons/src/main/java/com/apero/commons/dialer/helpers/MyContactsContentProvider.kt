...
class MyContactsContentProvider {
    companion object {
        private const val AUTHORITY = "com.callerid.commons.contactsprovider"
        ...
        fun getSimpleContacts(context: Context, cursor: Cursor?): ArrayList<SimpleContact> {
            ...
            if (packageName != "com.callerid.dialer" && packageName != "com.callerid.smsmessenger" && packageName != "com.callerid.calendar.pro") {
                return contacts
            }
